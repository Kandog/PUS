...
echo "Folder is not empty. Processing..."
...
#               echo "Building Permit Return is attached." | mailx -a $FileName -s "Paymentus (AMPD) - Return" -r ${FROM_ADDR} ${TO_ADDR}
                echo "Building Permit Return is attached." | mailx -a $FileName -s "Paymentus (AMPD) - Return" -r ${FROM_ADDR} ${TO_ADDR1}
#               echo "Building Permit Return is attached." | mailx -a $FileName -s "Paymentus (AMPD) - Return" -r ${FROM_ADDR} ${TO_ADDR2}
